...
$req = 'DELETE FROM reservations WHERE reservations_id = '.$reservations_id; 
$resultat = $covoiturage->query($req);


echo '<h2>vous venez de supprimer la réservation numéro '.$reservations_id.'.</h2>';
?>
